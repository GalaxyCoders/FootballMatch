...
import com.mqa.android.kade.adapter.FavoriteAdapter
...
class MatchesFav : Fragment(), AnkoComponent<Context> {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        adapter = FavoriteAdapter(requireContext(), favorites) {
            requireContext().startActivity<DetailActivity>("id_event" to "${it.idEvent}", "id_away" to "${it.idAwayTeam}", "id_home" to "${it.idHomeTeam}")
        }
    ...
    companion object {
        fun matchInstance(): MatchesFav = MatchesFav()
    }
}
